...
A Python-based console application designed to collect user information, handle different data types such as str, int, and float, inspect object metadata using type() and id(), and perform a basic arithmetic calculation.
